...
// Date:      2/23/2021
// Description:
//  Program creates a rectangle and a triangle using classes and definitions. This function mostly uses virutal and protected clases.
// From using this it creates and prints out a set of output for a rectangle and triangle measurements.
//
// 
//==========================================================
